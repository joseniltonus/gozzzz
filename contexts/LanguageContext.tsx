...
const translations = {
  pt: {
    ...
    'web.pricing.feature5': 'Pagamento único · sem renovação automática',
    ...
    'web.subscribe.ogDesc': 'Acesse o programa completo de 21 passos. Otimização do sono baseada em ciência. Pagamento único, acesso vitalício por R$ 147.',
    ...
    'web.subscribe.disclaimer': 'Pagamento único. Sem mensalidade. Sem renovação automática. Acesso imediato após confirmação.',
    ...
    'web.subscribe.feature8': 'Acesso vitalício — não é assinatura',
    ...
    'web.chronoPremium.ctaStartFree': 'Descobrir seu cronótipo — grátis',
    'web.chronoPremium.linkProgram': 'Ver o programa completo de 21 passos →',
    ...
    'web.pricing.annual.amount': '147',
    'web.pricing.annual.cents': '',
    ...
    // Web Metadata
    'web.meta.home.title': 'GoZzzz — Descubra Seu Cronótipo e Durma Melhor | Baseado em Ciência',
    'web.meta.home.description': 'Descubra em 60 segundos seu cronótipo biológico (Golfinho, Leão, Urso ou Lobo) e acesse o programa de sono em 21 passos baseado em pesquisa de Walker, Huberman, Czeisler e Breus. Acesso vitalício por R$ 147.',
    'web.meta.home.ogTitle': 'GoZzzz — Descubra Seu Cronótipo | Programa de Sono em 21 Passos',
    'web.meta.home.ogDesc': 'Teste gratuito de cronótipo em 60 segundos. Programa de 21 passos baseado em Walker, Huberman, Czeisler e Breus.',
    'web.meta.home.twitterTitle': 'GoZzzz — Descubra Seu Cronótipo Grátis',
    'web.meta.home.twitterDesc': 'Teste gratuito em 60 segundos. Programa de sono em 21 passos baseado em neurociência.',
    'web.pricing.ctaSubscribe': 'Acessar o programa — R$ 147',
  ...
  en: {
    ...
    'web.pricing.feature5': 'One-time payment · no auto-renewal',
    ...
    // Web Metadata
    'web.meta.home.title': 'GoZzzz — Find Your Chronotype and Sleep Better | Science-Based',
    'web.meta.home.description': 'Find your biological chronotype in 60 seconds (Dolphin, Lion, Bear, or Wolf) and access the 21-step sleep program built on research by Walker, Huberman, Czeisler, and Breus. One-time payment, lifetime access.',
    'web.meta.home.ogTitle': 'GoZzzz — Find Your Chronotype | 21-Step Sleep Program',
    'web.meta.home.ogDesc': 'Free 60-second chronotype test. 21-step program built on research by Walker, Huberman, Czeisler, and Breus.',
    'web.meta.home.twitterTitle': 'GoZzzz — Find Your Chronotype Free',
    'web.meta.home.twitterDesc': 'Free 60-second test. 21-step neuroscience-based sleep program.',
    'web.pricing.ctaSubscribe': 'Access the program — get started',
    ...
    'web.subscribe.ogDesc': 'Access the complete 21-step program. Science-based sleep optimization. One-time payment, lifetime access.',
    ...
    'web.subscribe.disclaimer': 'One-time payment. No subscription. No auto-renewal. Immediate access after confirmation.',
    ...
    'web.subscribe.feature8': 'Lifetime access — not a subscription',
    ...
    'web.chronoPremium.ctaStartFree': 'Find your chronotype — free',
    'web.chronoPremium.linkProgram': 'See the full 21-step program →',
  },
};
