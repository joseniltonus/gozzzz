...
const translations = {
  pt: {
    ...
    'web.nav.back': 'Voltar',
    'web.chronoLanding.kicker': 'Cronótipo',
    'web.chronoLanding.title': 'Quatro ritmos. Um lugar.',
    'web.chronoLanding.sub': 'Do Status ao TikTok — conteúdo curto, visual e premium para cada arquétipo.',
    'web.chronoLanding.ctaPrimary': 'Quero o programa',
    'web.chronoLanding.ctaSecondary': 'Ver o programa',
    'web.chronoPremium.heroHeadline': 'Você acorda cansado mesmo dormindo 8 horas?',
    ...
    'web.chronoPremium.scienceFoot':
      'Inspirado em pesquisas públicas de Matthew Walker, Michael Breus e Andrew Huberman. Conteúdo educativo; não reproduz quizzes ou marcas de terceiros.',
    'web.chronoPremium.gridLabel': 'Os quatro ritmos',
    'web.chronoPremium.valueTitle': 'Reprograme seu sono em 21 dias',
    ...
    // Web Metadata
    'web.meta.home.title': 'Descubra seu cronotipo — GoZzzz',
    'web.meta.home.description': 'Entenda por que você não dorme bem',
  ...
  en: {
    ...
    'web.nav.back': 'Back',
    'web.chronoLanding.kicker': 'Chronotype',
    'web.chronoLanding.title': 'Four rhythms. One home.',
    'web.chronoLanding.sub': 'From Status to TikTok — short, visual, premium content for every archetype.',
    'web.chronoLanding.ctaPrimary': 'Get the program',
    'web.chronoLanding.ctaSecondary': 'View the program',
    'web.chronoPremium.heroHeadline': 'You wake up tired even after 8 hours of sleep?',
    'web.chronoPremium.heroHeadlinePrefix': 'You wake up tired even after ',
    'web.chronoPremium.heroHeadlineHighlight': '8 hours of sleep?',
    'web.chronoPremium.heroHeadlineSuffix': '',
    'web.chronoPremium.heroSub': 'Discover your biological chronotype in 60 seconds',
    'web.chronoPremium.heroSubPrefix': 'Discover your biological chronotype in ',
    'web.chronoPremium.heroSubHighlight': '60 seconds',
    'web.chronoPremium.heroSubSuffix': '',
    ...
    'web.chronoPremium.trustSignup': 'No signup',
    ...
    'web.chronoPremium.scienceResearchersNames': 'Matthew Walker • Michael Breus • Andrew Huberman',
    'web.chronoPremium.heroPrivacyLine': '100% private • Your data is not stored',
    'web.chronoPremium.scienceFoot':
      'Inspired by public research from Matthew Walker, Michael Breus, and Andrew Huberman. Educational model; does not reproduce third-party quizzes or trademarks.',
    'web.chronoPremium.gridLabel': 'The four rhythms',
    'web.chronoPremium.valueTitle': 'Reset your sleep in 21 days',
    ...
    // Web Metadata
    'web.meta.home.title': 'Discover your chronotype — GoZzzz',
    'web.meta.home.description': 'Understand why you are not sleeping well',
