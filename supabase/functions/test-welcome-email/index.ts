      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background-color:#09061a;border-radius:12px 12px 0 0;padding:40px 32px;text-align:center;">
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#fbbf24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;margin-bottom:20px;">
        ...
        <tr>
          <td style="background-color:#09061a;border-radius:0 0 12px 12px;padding:20px 32px;text-align:center;">
            <p style="color:#3d3a52;font-size:12px;margin:0;line-height:18px;">
              &copy; 2026 <span style="color:#f5f5f5;">GoZzzz Morfeu</span>. Todos os direitos reservados.<br/>
              <a href="https://gozzzz.app" style="color:#d4a96a;text-decoration:none;">gozzzz.app</a><br/>
              MORFEU SA&Uacute;DE E TECNOLOGIA LTDA<br/>
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    await sendWelcomeEmail(Deno.env.get("RESEND_API_KEY")!, email, fullName || "");
    ...
    return new Response(
      JSON.stringify({ error: "Ocorreu um erro ao enviar o e-mail." }),
