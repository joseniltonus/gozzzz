 ...
 *
 * - If `EXPO_PUBLIC_PROGRAM_ACCESS_EMAILS` is unset: defaults to QA + clientes liberados manualmente.
...
function programAccessAllowlist(): Set<string> {
  ...
  const csv =
    raw === undefined || raw === null
      ? 'gozzzztest@gmail.com,recantodosavos1@gmail.com,diegosoaeso@gmail.com,edu.nassa@yahoo.com'
      : String(raw).trim();
